...
#unir bases de datos
bd1=full_join(x=bd_deso_c_mar, y=bd_deso_r_mar, by=c('DIRECTORIO','SECUENCIA_P','ORDEN'))
bd2=full_join(x=bd_carac_c_mar, y=bd_carac_r_mar, by=c('DIRECTORIO','SECUENCIA_P','ORDEN'))
bd3=full_join(x=bd_ing_c_mar, y=bd_ing_r_mar, by=c('DIRECTORIO','SECUENCIA_P','ORDEN'))
bd4=full_join(x=bd_vivi_c_mar, y=bd_vivi_r_mar, by=c('DIRECTORIO','SECUENCIA_P'))
